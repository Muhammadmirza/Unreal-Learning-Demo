 ...
 * 
 * 
 * We will return to this in the future once we learn about arrays.
 */

int main() // Every code must include a main function and this is where we execute the central part of the code
{   
    srand(time(NULL)); // create new random sequence based on time of day
    //Time(Null) returns time object of current Time
    //Srand accepts time(null) as a seed.
   ...
   {
      std::cout << "\n\nNumbers of Lives: " << NumberOfTries << "\n\n";
